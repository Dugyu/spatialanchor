...
namespace Microsoft.Azure.SpatialAnchors.Unity.Samples
{
    ...
    public class AzureSpatialAnchorsDemoWrapper : MonoBehaviour
    {
        ...
        private void Awake()
        {
            SpatialAnchorsAccountId = "cff005f1-1d07-426f-a593-96ccbe1f7885";
            SpatialAnchorsAccountKey = "E31K2VrqVs886n6/SdazS9SMFek056VReJ+HpBaB4zk=";
        }
        ...
        {
            bool processingWasEnabled = EnableProcessing;
            EnableProcessing = false;
            cloudSpatialAnchorSession.Reset();
            ResetSessionStatusIndicators();
            Task.Run(async () =>
            {
                ...
                lock (dispatchQueue)
                {
                    ...
                    {
                        EnableProcessing = processingWasEnabled;
